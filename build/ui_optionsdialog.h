...
**
** Created: Thu Mar 20 08:24:00 2014
...
public:
    ...
    eMarkAmountField *transactionFee;
    QSpacerItem *horizontalSpacer_Main;
    QCheckBox *eMarkAtStartup;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        transactionFee = new eMarkAmountField(tabMain);
        ...
        eMarkAtStartup = new QCheckBox(tabMain);
        eMarkAtStartup->setObjectName(QString::fromUtf8("eMarkAtStartup"));

        verticalLayout_Main->addWidget(eMarkAtStartup);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        eMarkAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start eMark after logging in to the system.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        eMarkAtStartup->setText(QApplication::translate("OptionsDialog", "&Start eMark on system login", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the eMark client port on the router. This only works when your router supports UPnP and it is enabled.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the eMark network through a SOCKS proxy (e.g. when connecting through Tor).", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting eMark.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        displayAddresses->setToolTip(QApplication::translate("OptionsDialog", "Whether to show eMark addresses in the transaction list or not.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
